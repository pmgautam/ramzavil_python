...
"""
Part of my tutorial at ramzavil.wordpress.com
This is a demo of connecting to MySQL database using PyMySQL database and performing insert, update and delete operations
Python data structures and control structures are used to provide intuitive user experience and code clarity
"""
...
def insert_records():
    ...
    try:
        with conn.cursor() as cursor:  # creating cursor object
...
def prepare_insert_query(table=None, name=None, address=None, position=None, salary=None):
    return "insert into {0}(name, address, position, salary) values ('{1}','{2}','{3}',{4})".format(table, name,
                                                                                                    address,
                                                                                                    position, salary)
